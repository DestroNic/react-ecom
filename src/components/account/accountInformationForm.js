    ...
    render() {
        ...
        return (
            <form onSubmit={handleSubmit} className={`${className} account-information-form`}>
                ...
                <Field className='account-information-form__change-password' onClick={() => console.log('trying to show password')} name='change-password' type='button' labelTitle='Password' title='Change Password'  component={LongGrayButton} />
            </form>
        )
    }
}
